...
export const Sidebar: React.FC = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-72 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 flex flex-col border-r border-slate-200 dark:border-slate-800 transition-transform duration-300 ease-in-out ${
      ...
      >
        ...
        {/* Branch Status Card from Design HTML */}
        <div className="p-4 m-4 bg-slate-900 rounded-2xl text-white shrink-0 shadow-sm">
        ...
        <div className="p-4 border-t border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-900/80 space-y-3">
